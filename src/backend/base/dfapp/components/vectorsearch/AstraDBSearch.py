...
from dfapp.components.vectorstores.AstraDB import AstraDBVectorStoreComponent
from dfapp.components.vectorstores.base.model import LCVectorStoreComponent
from dfapp.field_typing import Embeddings, Text
...
class AstraDBSearchComponent(LCVectorStoreComponent):
    ...
    def build(
        ...
        try:
            ...
            if "content" in str(e):
                raise ValueError(
                    "You should ingest data through Dataformer App (or LangChain) to query it in dfapp. Your collection does not contain a field name 'content'."
                )
            else:
                raise e
