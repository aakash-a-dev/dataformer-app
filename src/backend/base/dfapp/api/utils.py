...
from dfapp.services.store.schema import StoreComponentCreate
from dfapp.services.store.utils import get_lf_version_from_pypi
...
async def check_dfapp_version(component: StoreComponentCreate):
    from dfapp.version.version import __version__ as current_version  # type: ignore
